...
export interface ApiMovieMovie extends Schema.CollectionType {
  ...
  attributes: {
    ...
    types: Attribute.Relation<
      ...
      'api::type.type'
    >;
    Collection: Attribute.Enumeration<['movies', 'series']>;
    quality: Attribute.Enumeration<['HD', 'ZM']>;
    Sound: Attribute.Enumeration<['Thai', 'Sound Track']>;
    Youtube: Attribute.String;
    ep: Attribute.Component<'ep.ep', true>;
    movies: Attribute.Relation<
      'api::movie.movie',
      'manyToMany',
      'api::movie.movie'
    >;
    Recommended: Attribute.Relation<
      'api::movie.movie',
      'manyToMany',
      'api::movie.movie'
    >;
    Poppulate: Attribute.Boolean;
...
export interface ApiTypeType extends Schema.CollectionType {
  ...
  attributes: {
    Title: Attribute.String;
    Slug: Attribute.UID<'api::type.type', 'Title'>;
    movies: Attribute.Relation<
      'api::type.type',
      'manyToMany',
      'api::movie.movie'
